...
if __name__ == "__main__":
    pipeline = MLflowPipeline(
        ...
        tracking_uri='https://dagshub.com/Asm2910/MLOps_project.mlflow'
    )
    pipeline.run_pipeline(
        test_data_path = r"F:\mlops_water_potability\mlops\data\processed_data\test_processed.csv",
        model_path = r"F:\mlops_water_potability\mlops\models\model.pkl",
